...
REQUIRED = [
    ...
    "tests/test_phase6_qualification.py",
    "README.md",
    "CHANGELOG.md",
    "ROADMAP.md",
    "RELEASE_NOTES.md",
    ...
    "docs/history/SPRINT_2_8_3_RELAY_PACKET_EXTRACTION.md",
    "docs/TESTING.md",
    "docs/TROUBLESHOOTING.md",
    "docs/reconciliation/phase-2-shell-preparation.md",
    "docs/reconciliation/phase-3-bounded-integration.md",
    "docs/reconciliation/phase-7-live-relay-regression.md",
    "docs/reconciliation/phase-9-documentation-release-evidence.md",
    "tests/test_phase10_review_contract.py",
    ...
    "york_native_capture_importer.py",
    "protocols/york/native_capture.py",
    "protocols/york/schemas/native-capture.schema.json",
    "docs/tablet-removal/phase-1-native-command-discovery.md",
    "tests/test_tablet_removal_phase1.py",
